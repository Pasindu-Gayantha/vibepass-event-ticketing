                ...
                <div className="absolute top-full mt-1 w-48 bg-[#0a0a0f]/95 backdrop-blur-lg rounded-xl border border-purple-500/20 shadow-xl shadow-purple-500/10 py-1.5">
                  {eventDropdownItems.map((item) => (
                    <button
                      ...
                      className="w-full text-left px-4 py-2 text-sm text-gray-300 hover:text-rose-400 hover:bg-purple-500/10 transition-all"
                    >
                      {item.label}
                    </button>
                  ))}
          ...
          <div className="px-4 py-3 space-y-1">
            ...
            {eventDropdownItems.map((item) => (
              <button
                key={item.label}
                onClick={() => handleCategoryClick(item.category)}
                className="w-full text-left px-5 py-2 rounded-lg text-sm text-gray-300 hover:text-rose-400 hover:bg-purple-500/10 transition-all"
              >
                {item.label}
              </button>
            ))}
